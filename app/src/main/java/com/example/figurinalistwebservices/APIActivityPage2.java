...
public class APIActivityPage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnApiAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RequestQueue queue = Volley.newRequestQueue(APIActivityPage2.this);

                //url du service à consommer
                String url = "http://192.168.1.30:8082/ppe4/public/produit/apiall";
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                ArrayAdapter<String> arrayadapter = new ArrayAdapter<String>(APIActivityPage2.this, android.R.layout.simple_list_item_1, lesClients);
                                ...
                                lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        ...
                                        Toast.makeText(APIActivityPage2.this, tv.getText() + "  " + position, Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
